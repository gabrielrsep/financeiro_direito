...
Contexto do Projeto: Atue como um Desenvolvedor Fullstack Sênior e Especialista em UI/UX. Preciso criar uma aplicação web para um escritório de advocacia utilizando Nuxt 3 (Vue.js), Tailwind CSS e Neon postgress
...
Requisitos Funcionais (Back-end/Dados):
    ...
    Módulo Financeiro: > - Registro de "Valor Cobrado" por processo.
        ...
        Métodos de pagamento: Crédito, Débito, PIX, À Vista.
