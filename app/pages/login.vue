...
import { ShieldCheck, User, Lock, Loader2, AlertCircle, Eye, EyeOff } from 'lucide-vue-next'
...
async function handleLogin() {
  ...
  try {
    ...
    errorMessage.value = ex.data.message || 'Falha na autenticação.'
  }
  ...
  <div class="min-h-screen flex items-center justify-center bg-[#0a0f1c] p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md z-10">
      ...
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 shadow-lg shadow-blue-900/20 mb-4 border border-blue-400/20">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="relative group">
              ...
              <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'" required
                class="block w-full pl-10 pr-12 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all" />
              <button type="button" @click="showPassword = !showPassword"
                class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-blue-300 transition-colors"
          ...
          <Transition enter-active-class="transition duration-200 ease-out"
            ...
            <div v-if="errorMessage"
              class="flex items-center gap-2 p-3 rounded-xl bg-red-900/20 border border-red-800/30 text-red-400 text-sm">
